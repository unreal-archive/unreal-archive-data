...
* The Linux client now has an (experimental) wxWidgets-based launcher (`wx-ut-bin*`). This launcher adds support for the "preferences" console command. It requires wxWidgets 3.1.4 or later. (Thanks Buggie!)
