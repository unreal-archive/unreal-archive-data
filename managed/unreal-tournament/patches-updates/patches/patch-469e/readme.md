...
* Fixed a bug that could make Unreal Editor crash when deleting an actor whose Level property still referred to a deleted LevelInfo object ([#1400](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1400))
* Fixed a bug that could make Unreal Editor crash when adding mipmaps to a compressed texture without P8 mips ([#1395](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1395))
* Fixed a bug that could make Unreal Editor crash when building lights on very large maps
* Fixed a bug that made Unreal Editor crash when loading a map that actors whose names clash with names of actors on the previously loaded map ([#448](https://github.com/OldUnreal/UnrealTournamentPatches/issues/448))
* Fixed a bug that could make Unreal Editor crash after deleting actors ([#1069](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1069))
* We fixed several bugs that crashed UCC while importing meshes on Linux and macOS ([#1507](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1507))
...
* We fixed a bug that could wipe the UnrealEd or game ini ([#1879](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1879))
* We fixed a bug that made UnrealEd crash when joining polys on models that are used by different brushes ([#1911](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1911))
...
* We fixed a bug that made the game crash when you attempted to play a demo using the exec command line parameter ([#1774](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1774))
...
* Fixed a bug that could make the game or editor crash when rendering an actor mesh without a texture ([#700](https://github.com/OldUnreal/UnrealTournamentPatches/issues/700))
* Fixed a bug that could make SoftDrv crash when rendering certain meshes ([#545](https://github.com/OldUnreal/UnrealTournamentPatches/issues/545))
* Fixed a bug that could make the game or editor crash when enabling bFilterByVolume on certain actors ([#699](https://github.com/OldUnreal/UnrealTournamentPatches/issues/699))
* Fixed a bug that made the game freeze and eventually crash when rendering an incorrectly linked portal ([#522](https://github.com/OldUnreal/UnrealTournamentPatches/issues/522))
* We fixed a bug that could make the game crash when rendering a mover with an origin point in an invalid zone ([#1670](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1670))
...
* We fixed a bug that made ALAudio crash the game on startup on certain systems ([#1766](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1766))
* We fixed a bug that made OpenGLDrv crash the game on Linux systems that use the SDL2-on-SDL3 compatibility layer ([#1838](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1838))
* We fixed a bug that could make XOpenGLDrv crash the game due to an invalid memory allocation ([#1792](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1792))
* We fixed a problem that made VulkanDrv crash for most Linux users ([#1880](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1880))
* We fixed a bug that made D3D11Drv fail and sometimes even crash when rendering very complex meshes ([#1878](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1878))

#### Networking and Netcode

* Fixed a bug that could make the game crash when connecting to a server after executing the "reconnect" console command on the entry map ([#826](https://github.com/OldUnreal/UnrealTournamentPatches/issues/826))
* Fixed a bug that could make the game crash when executing the "reconnect" console command after watching a demo ([#1280](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1280))
* Fixed a bug that crashed the game when loading a map with the LevelInfo.bLonePlayer flag set to true ([#1461](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1461))
* Fixed a bug that made the ucc masterserver commandlet hang (on the first press) and then crash (on the second press) when pressing CTRL+C ([#1504](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1504))
* Fixed a bug that made the game crash when trying to play a demo file that depends on missing packages ([#1601](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1601))
* We fixed two bugs that could make the UZ decompression code crash while creating or destroying threads ([#1674](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1674))

#### Physics and Player Movement

* Fixed a bug that could make the game crash when a bot tried to move around on a map with invalid paths ([#1097](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1097))
...
* Fixed a bug that could crash the game or editor after changing a large number of properties in a properties window ([#1491](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1491))

#### Miscellaneous

* Fixed a bug that made the game crash on startup on macOS Sonoma 14.4 ([#1549](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1549))
...
* We fixed several bugs and glitches caused by improper handling of NaN vectors in Engine functions ([#1898](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1898))
* We made UCC make print warnings when you divide a vector by zero, as this would cause the aforementioned NaN issues
* We reduced the memory usage of the UZ compression and decompression functions and, at the same time, fixed a crash bug in these functions ([#1904](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1904))
...
* Fixed a bug that made it impossible to undo a cut operation on a NavigationPoint ([#1242](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1242), [clip](https://www.youtube.com/watch?v=PMpERQUIaqE))
* Fixed a bug that made it impossible to undo a right-click operation on a vertex ([#1168](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1168), [clip](https://www.youtube.com/watch?v=e0lrd3dFnDE))
* Fixed a bug that made Unreal Editor deselect the currently selected actors when pressing "Show Selected Actors Only" ([#1039](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1039), [clip](https://www.youtube.com/watch?v=LdhIR5OmZ-k))
* Unreal Editor should now correctly initialize all pivot components when placing a pivot in an ortho viewport ([#969](https://github.com/OldUnreal/UnrealTournamentPatches/issues/969), [clip](https://www.youtube.com/watch?v=XPEOLWW3vg4))
* Unreal Editor will now show the correct map name after failing to load a map ([#825](https://github.com/OldUnreal/UnrealTournamentPatches/issues/825))
* Unreal Editor will no longer clear the Region of all level actors after pasting an actor ([#621](https://github.com/OldUnreal/UnrealTournamentPatches/issues/621))
* The mesh and texture browsers should now ignore CAMERA ALIGN commands ([#516](https://github.com/OldUnreal/UnrealTournamentPatches/issues/516))
* Fixed a bug that made the texture browser show the wrong texture type for textures that only contain compressed data ([#1411](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1411))
* Fixed a bug that could make movers move or rotate inadvertently after building lights ([#1342](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1342))
* Fixed incorrect lighting of movers whose BrushRaytraceKey differed from their WorldRaytraceKey ([#668](https://github.com/OldUnreal/UnrealTournamentPatches/issues/668), [clip](https://www.youtube.com/watch?v=fKPAzylbb9U))
* Unreal Editor will now update the pivot location after resetting brushes ([#273](https://github.com/OldUnreal/UnrealTournamentPatches/issues/273))
* Fixed bugs that could make grid lines not render correctly ([#694](https://github.com/OldUnreal/UnrealTournamentPatches/issues/694), [#695](https://github.com/OldUnreal/UnrealTournamentPatches/issues/695))
* Fixed a bug that made vertices move too quickly when editing them in a maximally zoomed viewport ([#1419](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1419))
* Fixed a bug that made Unreal Editor ruin texture alignment when editing/transforming brushes ([#1161](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1161), [#1166](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1166), [clip 1](https://www.youtube.com/watch?v=VdPmMeCvdSQ), [clip 2](https://www.youtube.com/watch?v=Gve81ocdtls))
* Fixed several bugs that made it nearly impossible to vertex edit in 3D viewports ([#1299](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1299), [clip](https://www.youtube.com/watch?v=sueiduvgWM4))
* Fixed a bug that could make the active brush render incorrectly after importing an OBJ file ([#1422](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1422))
* The texture rotate command now works as expected for unproportionally scaled textures ([#1431](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1431), [clip](https://www.youtube.com/watch?v=y7l8aZTXDXk))
* Copy-pasting surface properties between surfaces with different orientations should now work as expected ([#1220](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1220))
* Fixed a bug that could cause vertices moved with ALT+LMB not to snap to the grid, even if the "snap to grid" option was enabled ([#1421](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1421))
* Unreal Editor will no longer prevent you from overwriting packages it previously failed to load ([#578](https://github.com/OldUnreal/UnrealTournamentPatches/issues/578))
* Fixed a bug that made the path builder inadvertently modify the collision settings of map actors ([#574](https://github.com/OldUnreal/UnrealTournamentPatches/issues/574))
* Fixed a bug that could make Unreal Editor export certain textures, sounds, and music files using the wrong name ([#1273](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1273))
* The actor browser should now select the correct class when pressing the "..." button for an actor property in the properties window ([#1326](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1326), [clip](https://www.youtube.com/watch?v=UldakgYEhMw))
* Fixed a bug that made the 2D shape editor revolve function calculate incorrect texture rotation angles ([#1426](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1426), [clip](https://www.youtube.com/watch?v=XxEYMB0DzJk))
* Fixed a bug that could make actor properties window freeze when editing actors that refer to each other ([#1462](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1462))
* Fixed a bug that made Unreal Editor produce small "dead zones" near invisible surfaces in some instances ([#554](https://github.com/OldUnreal/UnrealTournamentPatches/issues/554), [clip](https://www.youtube.com/watch?v=FWZdeBfPCM4))
...
* Fixed a bug that could make Unreal Editor hide identical property values in the actor browser when selecting multiple actors ([#270](https://github.com/OldUnreal/UnrealTournamentPatches/issues/270))
* Fixed several bugs that made the path builder build invalid or superfluous paths ([#129](https://github.com/OldUnreal/UnrealTournamentPatches/issues/129), [clip](https://www.youtube.com/watch?v=0FoSmliMPnw))
* Fixed a bug that made the TrueType font factory ignore single characters in UnicodeRange parameters of exec commands ([#1482](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1482))
* The mesh browser window should now have a menu when it is undocked ([#1447](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1447))
* Fixed a bug that made ucc make insert erroneous casts in some cases ([#1500](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1500))
* Fixed a bug that made Unreal Editor rebuild selected movers after using the "Show Polys" command ([#784](https://github.com/OldUnreal/UnrealTournamentPatches/issues/784))
* Fixed a bug that made surface polygons non-solid if one of their origin was outside the map boundaries (backport from Unreal 227) ([#1509](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1509))
* Fixed several rounding errors throughout the editor code
* Fixed a bug that could change the texture selection during rebuild operations ([#660](https://github.com/OldUnreal/UnrealTournamentPatches/issues/660))
* Fixed a bug that made non-scalable actors such as inventory float in the air after using the map scaling tool ([#1514](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1514), [clip](https://www.youtube.com/watch?v=xYjfFQ0-rEw))
* Fixed a bug that made the editor skip the compilation of new classes until you had modified their initial code ([#133](https://github.com/OldUnreal/UnrealTournamentPatches/issues/133))
* Fixed a bug that could destroy brushes when zooming or moving the camera while vertex editing ([#1540](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1540), [clip](https://www.youtube.com/watch?v=5B7kqjmnUkY))
* Fixed a bug that could destroy texture alignment for surfaces on which you had used OneTile alignment prior to rebuilding the map ([#1543](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1543))
* Fixed a bug that corrupted brushes when undoing certain editor operations
* Fixed a bug that made the brush importer corrupt the texture UV alignment on non-triangulated brushes ([#1560](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1560))
* Fixed a bug that made Unreal Editor discard the saved camera positions when loading a map ([#651](https://github.com/OldUnreal/UnrealTournamentPatches/issues/651), [clip](https://www.youtube.com/watch?v=GwyFtyzm0dc))
* Fix several bugs that made Unreal Editor lose track of the modification status of the map ([#289](https://github.com/OldUnreal/UnrealTournamentPatches/issues/289), [#490](https://github.com/OldUnreal/UnrealTournamentPatches/issues/490), [#615](https://github.com/OldUnreal/UnrealTournamentPatches/issues/615))
* Fixed several decompilation bugs in ScriptRays, including a bug that caused decompilation failures in functions that called Engine.Actor.Spawn ([#1570](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1570))
* Fixed a bug that could make editor windows disappear on multi-monitor systems ([#1556](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1556))
* Fixed a bug that could make the editor execute both the modified and unmodified versions of keyboard commands when you released keys in the wrong order ([#1588](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1588))
* Fixed a bug that made it impossible to access a class member variable when a function with the same name was in scope ([#902](https://github.com/OldUnreal/UnrealTournamentPatches/issues/902))
* Fixed a bug that could make the camera turn upside down after clicking an actor in the "Search For Actors" menu ([#1627](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1627))
...
* We fixed a bug that made it impossible to delete certain unused textures ([#1576](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1576))
...
* We fixed a bug that made the CTRL+ALT+RMB/LMB shortcuts copy unwanted surface flags ([#1487](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1487))
* We fixed a bug that made it impossible to assign music objects to variables such as LevelInfo.Song ([#1763](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1763))
* We fixed a bug that could break texture alignment after pressing one of the alignment buttons while multiple surfaces are selected ([#1760](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1760))
* The texture browser menu should now update correctly after changing the texture display size
* We fixed a bug that made Unreal Editor calculate the texture scale incorrectly when aligning certain surface textures ([#1777](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1777))
* We fixed a bug that made Unreal Editor apply mover scales incorrectly while rendering ([#1785](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1785))

#### UnrealScript

* Fixed a bug that could cause the game's random number generator to generate invalid numbers in rare cases. One known side effect of this bug is that paths could stop working in online games on certain maps ([#389](https://github.com/OldUnreal/UnrealTournamentPatches/issues/389))
* Fixed a bug that caused a mismatch between the Level.Millisecond and Level.Second values on Linux/Mac servers ([#1064](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1064))
* Fixed a bug that made it impossible to select certain skins (such as the Atomic Cow skin) in the in-game player setup menu ([#362](https://github.com/OldUnreal/UnrealTournamentPatches/issues/362))
* Fixed a bug that made the LevelInfo timer ignore changes to the game speed ([#1302](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1302))
* UBrowserHTTPClient should now report the correct HTTP error code for large error pages ([#1350](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1350))
* Fixed a bug that made the teleport effect play twice for bots spawning with bSpawnInTeamArea set to true ([#1387](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1387))
* Fixed a bug that made the game destroy your default weapon if you placed a destructive zone at the level origin ([#1020](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1020))
* Fixed an overflow bug that could make bots behave erratically and produce high CPU load when the "Auto Adjust Skill" option was enabled ([#1489](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1489))
* Fixed a bug that allowed you to continue giving orders to bots after the game had ended ([#1070](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1070))
* Fixed a bug that broke the Engine.ScriptedTexture.ReplaceTexture() function ([#1592](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1592))
* Fixed a bug that could cause runaway loop crashes in ScriptedPawn.RangedAttack
* Fixed a bug that prevented you from jumping if you had your DefaultPlayer.Name setting in User.ini set to a blank value ([#1623](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1623))
* We fixed a bug that made SaveConfig() save values with trailing spaces or trailing quotes incorrectly ([#1686](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1686))
...
* Fixed a bug that allowed AI-controlled Pawns to touch and pick up inventory even if their bCollideActors flag was set to false ([#773](https://github.com/OldUnreal/UnrealTournamentPatches/issues/773))
* Fixed a bug that could cause actors to get stuck in mid air in some cases ([#652](https://github.com/OldUnreal/UnrealTournamentPatches/issues/652), [clip](https://www.youtube.com/watch?v=Y3kM3UUQu_c))
* Fixed a bug that could cause actors/players to get stuck when they try to walk up a small step ([#866](https://github.com/OldUnreal/UnrealTournamentPatches/issues/866))
* Fixed a bug that could make bots run around aimlessly near ledges they wanted to jump down from ([#1568](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1586))
* Fixed a bug that made human players' view vibrate along the Z-axis when standing on a mover ([#720](https://github.com/OldUnreal/UnrealTournamentPatches/issues/720), [#1621](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1621))
* We fixed several collision bugs while maximally preserving compatibility with maps and mods that rely on quirks of the old collision code. We also added a new FixUpMoversBoundingBox option to the [Engine.GameEngine] section of the game ini. If this option is set to a non-zero value, the game and editor will detect and, potentially, fix up movers whose bounding box does encompass all inner collision hulls. If set to 1, we will expand the outer bounding box so all inner collision hulls become part of the outer bounding box. If set to 2, we will limit the size of the expansion to ensure the mover behaves (almost) identically in pre-469e clients/servers and post-469e clients and servers. The default value of FixUpMoversBoundingBox is 2 ([#1653](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1653), [#1655](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1655), [#1672](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1672))

#### Audio and 3D Rendering

* The game will now render sprites, meshes, and effects that are visible through portals in their correct locations ([#654](https://github.com/OldUnreal/UnrealTournamentPatches/issues/654), [#1448](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1448), [#218](https://github.com/OldUnreal/UnrealTournamentPatches/issues/218), [clip](https://www.youtube.com/watch?v=TH00uNX8uYk))
* Fixed a bug that could make textures stop panning after a while ([#1374](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1374), [clip](https://www.youtube.com/watch?v=P1dRlbMDy_A))
* Fixed an arithmetic bug in the Actor.LifeFraction function that made some actors (e.g., muzzle flashes) render incorrectly ([#625](https://github.com/OldUnreal/UnrealTournamentPatches/issues/625))
* Fixed a bug that made movers render incorrectly in levels with fully unlit level models ([#1417](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1417))
* Fixed a bug that made movers flicker on certain maps ([#1469](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1469), [clip](https://www.youtube.com/watch?v=weCXA7B0Axo))
* Fixed a bug that made invisible collision hulls prevent lights from illuminating meshes ([#1508](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1508), [clip](https://www.youtube.com/watch?v=8hsCbOhHKos))
* Fixed a bug that made decals produce flickering artifacts if they were placed near the edge of a surface ([#1510](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1510), [clip](https://www.youtube.com/watch?v=ATrhbseaKlo))
* Fixed a bug that caused animation of ice textures to stop at high frame rates
* Fixed a bug that made certain meshes disappear when viewed from certain angles/positions ([#1414](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1414), [clip](https://www.youtube.com/watch?v=2N50hljvBDA))
...
* All audio drivers can now play music from the Unreal Editor music browser even if their in-game music volume is set to 0 ([#1091](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1091))
* Weapon muzzle flashes should now render at 30 FPS even if the game itself runs at a much higher frame rate. This change should fix the screen tearing that previously appeared with weapons such as the minigun ([#1741](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1741))
* We fixed a bug that made weapons render incorrectly when using OpenGLDrv with certain versions of the Mesa drivers ([#1574](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1574))
...
* We fixed a bug in D3D11Drv, D3D12Drv, and VulkanDrv that made objects hidden behind clip planes visible when they should not be ([#1896](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1896))

#### Input and Windowing

* Fixed a bug that could make the game lose mouse focus, hide the mouse cursor, or enforce incorrect mouse cursor clipping bounds when entering fullscreen mode ([#1261](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1261), [#1000](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1000), [#488](https://github.com/OldUnreal/UnrealTournamentPatches/issues/488), [#1472](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1472))
* Fixed a bug that made Unreal Editor lose focus when undocking or closing all browser windows ([#728](https://github.com/OldUnreal/UnrealTournamentPatches/issues/728))
* Fixed a bug that made the minimize button disappear in some cases when switching to windowed mode ([#1546](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1546))
* Fixed a bug that could get the game stuck in a window resizing loop on Linux and macOS ([#1158](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1158))
* Fixed a bug that made it impossible to relaunch the game after changing video settings on Linux and macOS
* We fixed a bug that made you switch weapons when ALT+TAB'ing in and out of the game ([#1701](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1701))
* We fixed a bug that made you spawn looking up to the ceiling when using DirectInput ([#713](https://github.com/OldUnreal/UnrealTournamentPatches/issues/713))
* We fixed a bug that broke raw input for certain input devices
* We improved an earlier fix for a problem that made ALT+TAB switch weapons ([#1701](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1701))
...
* Fixed a bug that made it impossible to delete recently recorded demos ([#1290](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1290))
* Common render device options such as VolumetricLighting and Coronas will now show up in the Options subcategories in the preferences window ([#1262](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1262))
...
* We added a "DEVNETTRAFFICLOGS" console command that enables logging of replication traffic ([#722](https://github.com/OldUnreal/UnrealTournamentPatches/issues/722), [clip](https://www.youtube.com/watch?v=KYVbpHcKGKE))
...
* Undoing a texture rotate operation now correctly restores all rotated textures at once ([#1167](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1167), [clip](https://www.youtube.com/watch?v=6Hxy412ykP0))
* Unreal Editor now gracefully handles failures to spawn actors during t3d import operations ([#549](https://github.com/OldUnreal/UnrealTournamentPatches/issues/549))
* Improved readability of texture browser labels ([#959](https://github.com/OldUnreal/UnrealTournamentPatches/issues/959))
* You can now undo/redo vertex editing operations ([#677](https://github.com/OldUnreal/UnrealTournamentPatches/issues/677), [clip](https://www.youtube.com/watch?v=KCG9XkPVjqc))
* The POLY SELECT MATCHING BRUSH command will now select the surfaces of all selected brushes if no surfaces are initially selected ([#667](https://github.com/OldUnreal/UnrealTournamentPatches/issues/667), [clip](https://www.youtube.com/watch?v=eHRDz5Egdb4))
* Unreal Editor will now merge all zones without a ZoneInfo actor into one zone whenever we would otherwise exceed the maximum number of zones ([#690](https://github.com/OldUnreal/UnrealTournamentPatches/issues/690))
* Clarified the text in the map cleanup tool dialog ([#904](https://github.com/OldUnreal/UnrealTournamentPatches/issues/904))
* Ortho viewports will now calculate the LODBias value for rendered meshes based on the viewport zoom level rather than the distance between the camera and the mesh ([#262](https://github.com/OldUnreal/UnrealTournamentPatches/issues/262), [clip](https://www.youtube.com/watch?v=2m4DymUMqf4))
* Unreal Editor will no longer select camera viewports when box selecting ([#829](https://github.com/OldUnreal/UnrealTournamentPatches/issues/829), [clip](https://www.youtube.com/watch?v=yvR9TtZTxAU))
* Added or improved compiler warnings for several erroneous or dangerous operations ([#301](https://github.com/OldUnreal/UnrealTournamentPatches/issues/301), [#853](https://github.com/OldUnreal/UnrealTournamentPatches/issues/853), [#1420](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1420))
* Unreal Editor now shows the surface skew and angle in the stats tab of the surface properties window ([#924](https://github.com/OldUnreal/UnrealTournamentPatches/issues/924), [clip](https://www.youtube.com/watch?v=wxd2O0stg-A))
* You can now configure the lightmap scale/level of detail in the Unreal Editor build menu ([#1416](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1416), [clip](https://www.youtube.com/watch?v=AH5OLNLZDPQ))
* Unreal Editor no longer spams the log file with messages during path building ([#1413](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1413))
...
* Unreal Editor now shows the game build date and version in the main window ([#1221](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1221))
...
* The texture properties and replace dialogs will now render textures using the texture browser's renderer ([#1276](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1276))
...
* Unreal Editor will no longer open docked browser windows when it launches ([#1298](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1298))
* Added a 2D shape editor option that clears the shape you're currently editing ([#1378](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1378), [clip](https://www.youtube.com/watch?v=_6T4_t0M50Q))
* Unreal Editor will now show the size of the current selection rectangle in Unreal Units ([#1377](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1377))
* Unreal Editor will now warn you when one of the content browsers fails to save a package ([#686](https://github.com/OldUnreal/UnrealTournamentPatches/issues/686))
...
* The menu options and button tooltips for undo/redo will now show you which actions they will undo/redo ([#1205](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1205), [clip](https://www.youtube.com/watch?v=VZ_6RONafX4))
* You can now adjust the code editor font size using CTRL+Mouse Wheel or by setting the CodeFontSize option in the [Options] section of UnrealEd.ini ([#1317](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1317), [clip](https://www.youtube.com/watch?v=FnMT7LnxBx8))
* You can now merge polygons, even if their respective surfaces do not have identical properties ([#1323](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1323), [clip 1](https://www.youtube.com/watch?v=FMIAwDrJ1H8), [clip 2](https://www.youtube.com/watch?v=QerHyJRQPco))
...
* You can now select the "Uniform Shadows" option in the Unreal Editor build menu to make the editor build shadow maps whose scale is independent of their connected surface's scale ([#1435](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1435), [clip 1](https://www.youtube.com/watch?v=AH5OLNLZDPQ), [clip 2](https://www.youtube.com/watch?v=mrWEoXcZEAE))
* The path builder now builds faster, builds aerial paths ([#770](https://github.com/OldUnreal/UnrealTournamentPatches/issues/770)), and has a new button option that rebuilds only the changed paths ([#1239](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1239), [clip](https://www.youtube.com/watch?v=QFsX3APCZf8))
* Unreal Editor now gives up if it fails to build a new path network within a reasonable amount of time/iterations ([#383](https://github.com/OldUnreal/UnrealTournamentPatches/issues/383))
...
* You can now align textures while preserving their scale by holding the SHIFT key during alignment ([#676](https://github.com/OldUnreal/UnrealTournamentPatches/issues/676))
* Added brush order options that can memorize the selected brush's position or that can move the selected brush before or after the memorized position ([#681](https://github.com/OldUnreal/UnrealTournamentPatches/issues/681), [clip](https://www.youtube.com/watch?v=4AAu6RjAges))
* Integrated ScriptRays into the code editor so you can now decompile classes and view/edit the decompiled code ([#1444](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1444), [#1445](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1445), [clip](https://www.youtube.com/watch?v=GTyzd3iEypg))
* UCC make now prints a warning when it fails to resolve the target object of a default object property
* Added a build menu option to prevent the path builder from generating the (unused!) VisNoReach list. This can drastically reduce build times on maps with lots of path nodes ([#1473](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1473), [clip](https://www.youtube.com/watch?v=nYiKfJd1ZBQ))
* Unreal Editor can now play a beep sound after completing a slow action. By default, this message beep will play after completing an action that took more than 10 seconds. You can configure the duration threshold by setting/adding the "NotifyActionEndAfterSeconds" option in the [Options] section of UnrealEd.ini. Setting NotifyActionEndAfterSeconds to 0 will turn off the message beep ([#1490](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1490), [clip](https://www.youtube.com/watch?v=Us64sMd_-C4))
...
* The surface copy feature will no longer copy the PF_SemiSolid, PF_NotSolid, PF_TwoSided, and PF_Portal flags ([#1487](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1487), [clip](https://www.youtube.com/watch?v=3E-k0Otjmhs))
* Added a "Show Texture Grid" option to the viewport->View menu. This option renders the map in a (white) boxed view ([#1407](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1407), [clip](https://www.youtube.com/watch?v=EGbKPrztrFM))
* You can no longer select hidden brushes using SHIFT+LMB ([#1533](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1533), [clip](https://www.youtube.com/watch?v=JQOp7-40Syw))
* Added a surface menu option that can select the brushes whose surfaces you've selected ([#1528](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1528))
* All browser windows should now refresh after executing an OBJ LOAD command ([#628](https://github.com/OldUnreal/UnrealTournamentPatches/issues/628))
* Improved mipmap generation for images with low color depth ([#1408](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1408))
* Added group browser buttons that re-apply the visibility rules of the selected groups or all groups to actors in the groups ([#107](https://github.com/OldUnreal/UnrealTournamentPatches/issues/107), [#285](https://github.com/OldUnreal/UnrealTournamentPatches/issues/285), [#412](https://github.com/OldUnreal/UnrealTournamentPatches/issues/412), [#413](https://github.com/OldUnreal/UnrealTournamentPatches/issues/413))
* The texture import tool can now optionally use Bright to palletize P8 textures or ImageMagick to import textures stored in formats we do not natively support. To use these tools, install their respective binaries into the game's System folder, and check the "Use Bright" or "Use ImageMagick" boxes in the texture import dialog ([#1012](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1012))
...
* You can now edit vertices in the 2D and 3D viewports using SHIFT+LMB/RMB ([#1551](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1551))
* You can now scale vertices in the 2D viewports using CTRL+LMB+RMB ([clip](https://www.youtube.com/watch?v=OQnou7WLgCY))
* The brush exporter can now export non-triangulated brushes ([#1561](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1561))
* We added a new toolbar button that rebuilds the movers in your level ([clip](https://www.youtube.com/watch?v=nC187u3DLps))
* Added new menu options to toggle rendering of event lines ([#135](https://github.com/OldUnreal/UnrealTournamentPatches/issues/135), [clip](https://www.youtube.com/watch?v=PR3MKT1O4vQ))
* The group browser should now refresh automatically after adding an actor to the level ([#172](https://github.com/OldUnreal/UnrealTournamentPatches/issues/172))
* The vertices of selected brushes now render on top of all other brushes in vertex editing mode. This should make these vertices much easier to select ([#1037](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1037))
* Added a new toolbar button that shows all actors except those in hidden groups ([#1544](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1544))
* You can now undo the "Snap vertices to grid" operation ([#1565](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1565))
* You can now replace selected brushes with brushes of other classes ([#455](https://github.com/OldUnreal/UnrealTournamentPatches/issues/455))
* Unreal Editor and UCC will now save files using a temporary file name if they cannot be saved with the desired file name
* ScriptRays can now decompile switch statements ([#1511](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1511))
...
* You can now use the CTRL+SHIFT+Z shortcut to redo a previously undone operation ([#1586](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1586))
...
* You can now copy/paste surface properties ([#675](https://github.com/OldUnreal/UnrealTournamentPatches/issues/675), [#931](https://github.com/OldUnreal/UnrealTournamentPatches/issues/931), [clip](https://www.youtube.com/watch?v=rBtz2h9V7vo))
* Unreal Editor can now import dds textures saved by UT2004's editor ([#982](https://github.com/OldUnreal/UnrealTournamentPatches/issues/982))
* The texture browser, mesh browser, and texture preview windows will no longer emit ambient sounds ([#1455](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1455), [clip](https://www.youtube.com/watch?v=VLrRBDdEIqQ))
* You can now enable rendering and selection of mover surfaces in 3D viewports ([#671](https://github.com/OldUnreal/UnrealTournamentPatches/issues/671), [clip](https://www.youtube.com/watch?v=_QlEa19T9wU))
* You can now set the KeepRealtimePreviewOnPlay option in the [Options] section of UnrealEd.ini to keep the realtime preview viewport option enabled after launching a map from the editor ([#322](https://github.com/OldUnreal/UnrealTournamentPatches/issues/322))
* You can now box-select vertices in 3D viewports using CTRL+ALT+LMB ([#1552](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1552), [clip](https://www.youtube.com/watch?v=ac6Jz_UVNUk))
...
* We implemented "Snake Alignment", a feature that allows you to align textures that span multiple surfaces. To use snake alignment, you should manually align the texture on one surface, then click that surface using SHIFT+CRTL+ALT+RMB, and finally click adjacent surfaces using SHIFT+CTRL+ALT+LMB ([#868](https://github.com/OldUnreal/UnrealTournamentPatches/issues/868), [clip](https://www.youtube.com/watch?v=PZOgWRN8wgo))
* We implemented undo/redo for the 2D shape editor ([#1246](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1246), [clip](https://www.youtube.com/watch?v=GLZgcOGhEHo))
* We added a "Merge Shapes" menu option to the 2D shape editor. This option allows you to merge the selected shapes into one polygon ([#1550](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1550), [clip](https://www.youtube.com/watch?v=RMkby6g-aNI))
...
* The Viewport View Menu now has an "Occlude Lines" option. When enabled, this option hides line segments that are occluded by level geometry ([#1451](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1451), [clip](https://www.youtube.com/watch?v=5Gl_nOaXc9g))
...
* The editor will no longer warn you about broken movers or compatibility problems when it autosaves a map ([#1673](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1673))
...
* Clicking on an editor viewport title bar will now activate that viewport ([#1769](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1769))
* We made the UnrealEd code editor refresh the list of open scripts after renaming a file ([#1908](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1908))

#### UnrealScript

* The game will now report the last known location for actors that fell out of the world ([#1390](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1390), [clip](https://www.youtube.com/watch?v=5okG85wyKow))
* The game now resets and recalculates each actor's StandingCount when loading a map ([#1341](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1341))
* The game now resets the Level.TimeDilation value when loading a map ([#1373](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1373))
* The in-game preferences menu will now populate the video resolution list with common resolutions if the renderer fails to report supported resolutions ([#1452](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1452))
...
* You can now modify the speed at which PlayerPawns move in state CheatFlying by editing the PlayerPawn.CheatFlyingSpeed property ([#1258](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1258))
* The game mode and game type filters in the in-game server browser are now case-insensitive ([#1437](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1437))
* UWindowWindow.SetAcceptsFocus() should now work as expected even if the Window's parent has changed since the previous call ([#897](https://github.com/OldUnreal/UnrealTournamentPatches/issues/897))
* The map selection dialogs now support level screenshots with unexpected names ([#926](https://github.com/OldUnreal/UnrealTournamentPatches/issues/926))
* The in-game server browser now shows you useful information such as the game speed, remaining time, elapsed time, and much more ([#439](https://github.com/OldUnreal/UnrealTournamentPatches/issues/439))
* The default HUD will now render a solid chat area if you set the HUD opacity to the maximum value ([#640](https://github.com/OldUnreal/UnrealTournamentPatches/issues/640), [clip](https://www.youtube.com/watch?v=JmdoHu74SH8))
* Added a new preferences menu option to adjust your Field of View (FOV) angle ([#1375](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1375))
* Added a new preferences menu dropdown box to switch between fullscreen, windowed, and borderless windowed (if available) mode ([#42](https://github.com/OldUnreal/UnrealTournamentPatches/issues/42))
* UTrace now works for state code ([#1171](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1171))
* UTrace now causes much less CPU load than before ([clip](https://www.youtube.com/watch?v=ozVagr5immA))
* Added a "RUNAWAYCOUNTER" console command that returns the current value of the runaway counter ([#774](https://github.com/OldUnreal/UnrealTournamentPatches/issues/774), [clip](https://www.youtube.com/watch?v=TpHZ8RzHczg))
* Added an UnrealScript profiler that outputs JSON-compatible profiling information in the game log. You can use the "UPROFILE" console command to to turn profiling on and off ([#865](https://github.com/OldUnreal/UnrealTournamentPatches/issues/865), [clip](https://www.youtube.com/watch?v=LZlg_wPpiAU))
* Added a "UTRACE" console command that turn the UnrealScript tracer (originally added by UTPG) on and off ([#1527](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1527), [clip](https://www.youtube.com/watch?v=iqGA18PpGjg))
* Added a "BACKTRACE" console command that returns a dump of the current UnrealScript call stack ([#72](https://github.com/OldUnreal/UnrealTournamentPatches/issues/72), [clip](https://www.youtube.com/watch?v=AEcr95CD3Oc))
* The game will now dump the UnrealScript call stack to the log file whenever it crashes with an infinite script recursion error ([#1474](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1474))
* You can now use the "SPEC" or "PLAY" console commands to reconnect to the server as a spectator or player respectively. In addition, you can use the "RED", "BLUE", "GREEN", or "GOLD" console commands to change to the respective teams ([#1043](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1043), [clip](https://www.youtube.com/watch?v=bYaBsn2XDn4))
* "SET" console commands now produce a feedback message that includes the full name of the modified property and its updated value ([#755](https://github.com/OldUnreal/UnrealTournamentPatches/issues/755))
* Increased the width of the text boxes in the advanced video settings menu ([#1585](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1585))
* The "Voice Messages" option in the in-game audio settings menu will now be visible even if you are not spectating a game ([#1590](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1590))
* Improved performance of all mods and menus that enumerated or iterated over all installed skins ([#1598](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1598))
* We added various new key binding options to the in-game controls menu ([#1611](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1611), [#1613](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1613))
...
* The server browser will now remember and restore the heights of its sub-windows ([#1362](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1362))
* The "RELOADCONFIG" command will now reload the configuration of all instances of the specified class
* The FOV textbox in the in-game video settings menu now supports floating-point values ([#1704](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1704))
...
* You can now enable the moving brush tracker on servers by setting the Engine.GameEngine.UseNetMovingBrushTracker option to true. By enabling the moving brush tracker, AI-controlled actors such as Bots, Monsters, and ScriptedPawns, will no longer ignore movers ([#559](https://github.com/OldUnreal/UnrealTournamentPatches/issues/559), [clip](https://www.youtube.com/watch?v=8jSB5tZlf8E))
* We backported Marco's octree collision code (originally written for Unreal 227) to UT. This code detects collisions more accurately and with a dramatically lower computational cost, resulting in reduced load on servers that run custom mods such as XVehicles. The octree collision code is enabled by default but can be disabled by setting the Engine.GameEngine.UseOctreeCollisionHash option to false ([#582](https://github.com/OldUnreal/UnrealTournamentPatches/issues/582), [#371](https://github.com/OldUnreal/UnrealTournamentPatches/issues/371), [clip 1](https://www.youtube.com/watch?v=vjftKYAcvk0), [clip 2](https://www.youtube.com/watch?v=6ExOWSoKiWY))

#### Audio and 3D Rendering

* The game can now apply widescreen-friendly Hor+ Field of View (FOV) scaling while maintaining the correct weapon and muzzle flash positioning (External Contribution by Masterkent) ([#111](https://github.com/OldUnreal/UnrealTournamentPatches/issues/111), [clip](https://www.youtube.com/watch?v=F5cUR_sNWVo))
* You can now enable and disable vertical synchronization when playing with the OpenGLDrv renderer on a Linux/ARM platform
* Light actors that use the LT_Flicker LightType will now update approximately 30 times per second ([#1216](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1216))
* We added a "TRYRENDERDEVICE" console command that allows you to switch to a different renderer without restarting the game ([#1319](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1319), [clip](https://www.youtube.com/watch?v=OAL933bs35Y))
* We added a shader-based gamma correction mode to D3D9Drv. This new mode can reliably apply gamma correction to the game, even when it is running in windowed mode. You can enable shader-based gamma correction by changing the UseShaderGamma option in the [D3D9Drv.D3D9RenderDevice] section of the game ini. If set to 0, D3D9Drv will use its old (and extremely unreliable) gamma correction method. If set to 1, D3D9Drv will use the new method in windowed mode and the old method in fullscreen mode. If set to 2, D3D9Drv will always use the new method ([#491](https://github.com/OldUnreal/UnrealTournamentPatches/issues/491))
* Galaxy will no longer flood the game log with useless debug messages during music transitions ([#1340](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1340))
* Galaxy now supports the 96 kHz and 192 kHz output rates ([#1651](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1651))

#### Input and Windowing

* The editor/game log window can now be minimized and maximized
* The game will now automatically switch to windowed mode when you launch the actor editor ([#1296](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1296))
* The game will now remove the window borders when you use windowed mode with a resolution equal to or larger than the screen resolution ([#1364](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1364))
...
* The game will now log a more descriptive error when it tries to load a package without a valid header ([#1389](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1389))
...
* The game will now show you a more descriptive error message when you try to launch it from a game folder that does not contain the required game data ([#1248](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1248))
* The game will now decompress the entry map on-the-fly if it finds Entry.unr.uz but cannot find Entry.unr. This change will allow players who skip the map decompression step of the game installation to play the game ([#497](https://github.com/OldUnreal/UnrealTournamentPatches/issues/497), [#1339](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1339), [#1505](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1505), [#1665](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1665))
...
* Cache purging is now disabled by default ([#1706](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1706))
...
* This patch adds support for Linux-aarch64/ARMv8 platforms. This means you can now host servers (or even play the game) on your Raspberry Pi 3/4! ([#1013](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1013), [Patreon Post](https://www.patreon.com/posts/83522201))
* Good news for movement-centric game types such as BunnyTrack: This patch fixes several long-standing movement and networking issues! (e.g., [#782](https://github.com/OldUnreal/UnrealTournamentPatches/issues/782), [#805](https://github.com/OldUnreal/UnrealTournamentPatches/issues/805), [#228](https://github.com/OldUnreal/UnrealTournamentPatches/issues/228))
...
* Fixed a bug that could crash the macOS game client upon startup ([#945](https://github.com/OldUnreal/UnrealTournamentPatches/issues/945))
* Fixed a bug that could crash the macOS game client when a mod tried to access the Engine.Actor.Touching array. This bug made it impossible to play Nali Weapons III on macOS ([#1154](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1154))
...
* Fixed a bug that could make the game freeze after pressing the jump key while spectating on maps such as AS-HiSpeed ([#732](https://github.com/OldUnreal/UnrealTournamentPatches/issues/732), External Contribution by Buggie)
* Fixed a bug that could make the game crash if a SkaarjBerserker tried to attack a friendly player ([#1066](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1066), External Contribution by Buggie)
* Fixed a bug that could make the game crash when calling UPlayer::Destroy during garbage collection ([#1398](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1398))

#### Unreal Editor

* Fixed a bug that could make the editor crash while creating fonts with the TrueTypeFontFactory ([#1368](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1368))
* Fixed a bug that made the editor crash when attempting to export a compressed texture without P8 data ([#1396](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1396))
* Fixed a bug that made the editor crash when unaligning a surface after deleting its brush ([#1254](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1254))

#### Audio and 3D Rendering

* Fixed bugs that could crash D3D9Drv when importing non-power-of-two textures ([#1003](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1003), External Contribution by Buggie)
* Fixed a minor rendering glitch that triggered when using D3D9Drv in a window whose width had an uneven number of pixels ([#1019](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1019), External Contribution by Buggie)

### Bug Fixes

#### Physics and Player Movement

* Fixed a bug that could cause the camera to rotate rapidly when jumping on a kicker ([#782](https://github.com/OldUnreal/UnrealTournamentPatches/issues/782))
* Fixed a bug that could make actors trigger spurious Touch/UnTouch events just before colliding with each other. As a side effect of this bug, some kickers applied too momentum to the players they kicked ([#228](https://github.com/OldUnreal/UnrealTournamentPatches/issues/228))

#### Networking and Netcode

* Fixed a bug that broke decompression of certain compressed files downloaded from redirect servers ([#656](https://github.com/OldUnreal/UnrealTournamentPatches/issues/656))
* Fixed a bug that broke client-side physics simulation of certain projectiles and items ([#1196](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1196))
...
* The "None" group should now be visible in the sound browser ([#908](https://github.com/OldUnreal/UnrealTournamentPatches/issues/908), External Contribution by Buggie)
* Fixed a bug that made the 2D editor produce invalid cylinders ([#991](https://github.com/OldUnreal/UnrealTournamentPatches/issues/991), External Contribution by Buggie)
* Fixed a bug that made the 2D editor incorrectly render the grid after zooming ([#994](https://github.com/OldUnreal/UnrealTournamentPatches/issues/994), External Contribution by Buggie)
...
* Fixed several bugs that made it impossible to use classes/objects with spaces, brackets, or parentheses in their names ([#1124](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1124), [#1072](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1072), [#930](https://github.com/OldUnreal/UnrealTournamentPatches/issues/930))
...
* Fixed a bug that sometimes made the pivot silently snap to the grid ([#458](https://github.com/OldUnreal/UnrealTournamentPatches/issues/458))
* Fixed bugs that caused erratic in-game input behavior after launching the game through the editor "Play Map" button ([#1204](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1204), [#1203](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1203), [#1202](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1202))
* Fixed a bug that forced the game log window to the background after launching the game through the editor "Play Map" button ([#447](https://github.com/OldUnreal/UnrealTournamentPatches/issues/447))
* Fixed a misleading error message that appeared when compiling a class with a struct declared in a local function scope ([#1403](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1403))
* Fixed a bug that sometimes made it impossible to import sounds and music into the "None" group ([#1345](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1345))
* Fixed a bug that made the editor calculate incorrect iWarpZone values for portals with unexpected iZonePortalSurf values ([#521](https://github.com/OldUnreal/UnrealTournamentPatches/issues/521))
...
* Fixed a bug that could make the secondary enforcer produce sounds from the wrong location ([#277](https://github.com/OldUnreal/UnrealTournamentPatches/issues/277))
* Fixed a bug that allowed TeamCannons to shoot through thin walls ([#614](https://github.com/OldUnreal/UnrealTournamentPatches/issues/614), External Contribution by Buggie)
* Fixed various accessed none errors ([#314](https://github.com/OldUnreal/UnrealTournamentPatches/issues/314), [#1153](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1153), [#1053](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1053), [#1050](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1050), [#892](https://github.com/OldUnreal/UnrealTournamentPatches/issues/893), External Contribution by Buggie)
* UTFadeTextArea controls now correctly calculate their scroll limits ([#901](https://github.com/OldUnreal/UnrealTournamentPatches/issues/901), External Contribution by Buggie)
* Fixed a bug that could prevent Mercenary pawns from dying even when their health dropped below 0 ([#551](https://github.com/OldUnreal/UnrealTournamentPatches/issues/551), External Contribution by Buggie)
* Fixed a bug that made certain fonts on the team scoreboard not scale with the game resolution ([#960](https://github.com/OldUnreal/UnrealTournamentPatches/issues/960), External Contribution by Buggie)
* Fixed a bug that made "timedemo 1" report an incorrect frame rate if the entry level had a non-standard time dilation set ([#1033](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1033), External Contribution by Buggie)
* Fixed a bug that made (nearly) all default game types ignore the ?timelimit URL parameter (External Contribution by Deaod)
* Fixed a bug that made the dodge timer reset duration dependent on player ping ([#805](https://github.com/OldUnreal/UnrealTournamentPatches/issues/805), External Contribution by Deaod)
* The UnrealShare.ScriptedPawn.AttitudeTo bug fix for TeamGamePlus games is now disabled by default because some mods relied on 436's (incorrect) behavior. You can manually re-enable this fix by setting the bTeamGamePlusFix config variable to true for each pawn type that handles TeamGamePlus games correctly ([#1183](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1183))
* We partially reverted UTPG's illegal skin check. Bots should now, once again, be able to use skins from all ServerPackages ([#1179](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1179), [#56](https://github.com/OldUnreal/UnrealTournamentPatches/issues/56))
* Fixed a bug that could cause lag spikes on servers when a client requested the server's mutator list ([#1218](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1218))
* Fixed a bug that made the exec console command incorrectly parse its arguments ([#1279](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1279))
* The AddToPackageMap and IsInPackageMap should now work as expected
* Fixed a bug that made certain crosshairs render incorrectly when disabling 469's crosshair translucency setting ([#1405](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1405))

#### Audio and 3D Rendering

* Fixed a bug that could give the game window incorrect dimensions after changing the game resolution on a macOS system
* Fixed a bug that made it impossible for certain renderers (such as OpenGLDrv) to acquire an exclusive fullscreen window. As a side effect of this bug fix, (mouse) input latency should now be noticeably lower when using these renderers ([#795](https://github.com/OldUnreal/UnrealTournamentPatches/issues/795))
* Fixed a bug that made ALAudio restart the currently playing music track after pasting or duplicating an actor (External Contribution by Buggie) ([#1325](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1325))
* Fixed a bug that caused choppy music playback in ALAudio after CPU load spikes (External Contribution by Buggie) ([#1330](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1330))
* Fixed a bug that made ALAudio loop OGG music tracks too early (External Contribution by Buggie) ([#1332](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1332))
* Fixed a bug that made ALAudio corrupt OGG sounds and music tracks in packages saved using UnrealEd (External Contribution by Buggie) ([#1344](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1344))
* Fixed a bug that caused inaccurate playback of ambient sounds when playing with ALAudio and HRTF enabled (External Contribution by Buggie) ([#1338](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1338))
...
* Fixed a bug that made it impossible to load savegames if the saved map had lazy-loaded sounds, music, or meshes ([#1275](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1275))

### Enhancements

#### Input and Windowing

* Rewrote the mouse input handling code and made raw mouse input work in Unreal Editor. Enabling raw input in Unreal Editor should drastically improve the mapping experience for users with high-DPI mice ([#1026](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1026))
* Made the window manager remember and restore the maximized state of all game and editor windows ([#571](https://github.com/OldUnreal/UnrealTournamentPatches/issues/571), External Contribution by Buggie)
* Added support for keyboard navigation in wizard windows such as those used in the Setup utility ([#870](https://github.com/OldUnreal/UnrealTournamentPatches/issues/870), External Contribution by Buggie)
* Made text entered in terminal windows (such as the Unreal Editor log window) editable ([#873](https://github.com/OldUnreal/UnrealTournamentPatches/issues/873), External Contribution by Buggie)
* Made it possible to toggle individual polyflags in the actor properties window ([#691](https://github.com/OldUnreal/UnrealTournamentPatches/issues/691), External Contribution by Buggie)

#### Unreal Editor

* Made Unreal Editor always render the builder brush even if it has bHiddenEd set to true ([#102](https://github.com/OldUnreal/UnrealTournamentPatches/issues/102))
...
* Added a new actor browser tool that allows you to load all of a package's classes ([#878](https://github.com/OldUnreal/UnrealTournamentPatches/issues/878), External Contribution by Buggie)
...
* Unreal Editor viewports can now be maximized and minimized by double clicking on their toolbar ([#562](https://github.com/OldUnreal/UnrealTournamentPatches/issues/562), External Contribution by Buggie)
* Added button tooltips in the group browser (External Contribution by Buggie)
* Added support for common hotkeys in various Unreal Editor windows and dialogs ([#877](https://github.com/OldUnreal/UnrealTournamentPatches/issues/877), External Contribution by Buggie)
* Added a bottom bar button to enable/disable in-editor sound ([#504](https://github.com/OldUnreal/UnrealTournamentPatches/issues/504), External Contribution by Buggie)
...
* Added a new "match whole word" search option to the search actors dialog ([#905](https://github.com/OldUnreal/UnrealTournamentPatches/issues/905), External Contribution by Buggie)
* Added a new editor tool that allows you to scale selected actors ([#806](https://github.com/OldUnreal/UnrealTournamentPatches/issues/806), External Contribution by Buggie)
* Added a new editor tool ("Array") that allows you to create duplicates of the selected actor with configurable location, rotation, or scaling offsets added to each subsequent duplicate ([#809](https://github.com/OldUnreal/UnrealTournamentPatches/issues/809), External Contribution by Buggie)
* Added a new editor tool that allows you to randomly rotate all selected actors ([#810](https://github.com/OldUnreal/UnrealTournamentPatches/issues/810), External Contribution by Buggie)
* Added several new options to the 2D cylinder shape editor ([#992](https://github.com/OldUnreal/UnrealTournamentPatches/issues/992), [#1047](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1047), [#1136](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1136), [#1137](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1137) External Contribution by Buggie)
* Made it possible to export the code of selected actors in the actor browser ([#707](https://github.com/OldUnreal/UnrealTournamentPatches/issues/707), External Contribution by Buggie)
...
* Added a new actor browser tool that allows you to save the configuration file for the selected class ([#1017](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1017), External Contribution by Buggie)
...
* You can now declare up to 30 user-defined button groups in Unreal Editor ([#1147](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1147), External Contribution by Buggie)
...
* Added "In Use", "All Textures", and "Most Recently Used" tabs to the texture browser ([#966](https://github.com/OldUnreal/UnrealTournamentPatches/issues/966), External Contribution by Buggie)
* Added the Actor.PrePivot property to the Display category in the actor properties window ([#1182](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1182), External Contribution by Buggie)
* Made the code editor export default object and class properties with their shortest possible unambiguous name ([#778](https://github.com/OldUnreal/UnrealTournamentPatches/issues/778))
...
* D3D9Drv and OpenGLDrv now allow you to configure the color for selected surfaces in Unreal Editor ([#823](https://github.com/OldUnreal/UnrealTournamentPatches/issues/823))
* Unreal Editor no longer adds a leading space to the command line parameters it passes to the game if said parameters start with a '?' character. This means you should now be able to set Editor.EditorEngine.GameCommandLine to, for example, "?Game=Botpack.CTFGame?Mutator=Botpack.InstaGibDM -log" ([#529](https://github.com/OldUnreal/UnrealTournamentPatches/issues/529))
* The editor now gives you line information when warning about an unreferenced local variable during UnrealScript compilation ([#355](https://github.com/OldUnreal/UnrealTournamentPatches/issues/355))
...
* Increased the number of stored server passwords from 10 to 50 ([#893](https://github.com/OldUnreal/UnrealTournamentPatches/issues/893), External Contribution by Buggie)
* Made the mutator list in the in-game server browser easier to read ([#894](https://github.com/OldUnreal/UnrealTournamentPatches/issues/894), External Contribution by Buggie)
* You can now press the F4 button in the in-game server browser to re-ping all servers ([#896](https://github.com/OldUnreal/UnrealTournamentPatches/issues/896), External Contribution by Buggie)
...
* Implemented a "ReloadConfig <x>" console command that allows you to reload the configuration file of the specified object or class. If you do not specify any object or class, reloadconfig will reload the configuration of all known objects and classes ([#480](https://github.com/OldUnreal/UnrealTournamentPatches/issues/480))
* Added a new advanced renderer properties window to the in-game menu
* Changed the default value of Botpack.CTFGame.bAutoRespawnFlags to false because the true setting broke BunnyTrack ([#279](https://github.com/OldUnreal/UnrealTournamentPatches/issues/279))
...
* If a function call gets absorbed, the UnrealScript VM will now return a default-initialized return value for the called function ([#1226](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1226))
...
* The player mesh in the player setup window should now rotate at a frame rate-independent speed (External Contribution by Buggie) ([#1393](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1393))

#### Audio and 3D Rendering

* Added support for various new audio formats (many of which were already supported by Galaxy and Cluster) in ALAudio ([#324](https://github.com/OldUnreal/UnrealTournamentPatches/issues/324))
* The game should now be able to enforce high frame rate caps on Windows ([#176](https://github.com/OldUnreal/UnrealTournamentPatches/issues/176))

#### Networking and Netcode

* The UZ compression and decompression code is now multithreaded. This should substantially increase (de)compression speed on clients and in UCC ([#935](https://github.com/OldUnreal/UnrealTournamentPatches/issues/935), External Contribution by Buggie)
* The game will now try to reload packages when you're connecting to a server that runs a different version of a package that is already loaded. This should result in far fewer failed connections due to "Package Version Mismatches" ([#1251](https://github.com/OldUnreal/UnrealTournamentPatches/issues/1251))
* The game will now display the total download progress when downloading packages from a game server ([#443](https://github.com/OldUnreal/UnrealTournamentPatches/issues/443))
